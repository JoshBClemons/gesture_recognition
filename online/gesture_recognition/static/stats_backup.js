...
(function request_stats() {
    socket.emit('request_stats', {data: 'hey'});
})()
socket.on('stats', function(output) { 
    
    imgsrc = 'data:image/jpeg;base64,' + output.image;
    debugger
    var img = new Image()
    img.onload = function() {
        // draw training image
...
var cr_addresses = [
    "/static/images/model_0_classification_report.png",
    "/static/images/model_1_classification_report.png",
    "/static/images/model_2_classification_report.png",
]
var cm_addresses = [
    "/static/images/model_0_confusion_matrix.png",
    "/static/images/model_1_confusion_matrix.png",
    "/static/images/model_2_confusion_matrix.png",
]
var img_addresses = [
    "/static/images/todays_user_activity.png",
    "/static/images/gesture_prediction_accuracy_by_date.png",
    "/static/images/total_user_usage_time_by_date.png",
    "/static/images/true_gesture_counts_by_date.png",
]
...
m0cm.onload = function () {
    ...
    m1cr.src = cr_addresses[1];
    m1cm.src = cm_addresses[1];
    m2cr.src = cr_addresses[2];
    m2cm.src = cm_addresses[2];
    //load daily user activity figure
    todays_user_act.src = img_addresses[0];
...
todays_user_act.onload = function () {
    ...
    pred_acc_date.src = img_addresses[1];
}
...
pred_acc_date.onload = function () {
    ...
    user_usage.src = img_addresses[2];
}
user_usage.onload = function () {
    ...
    gest_counts.src = img_addresses[3];
}

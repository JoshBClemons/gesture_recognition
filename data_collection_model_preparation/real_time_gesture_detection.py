...
model = load_model('C://Users//clemo//git//motion_identification//model_preparation//VGG_cross_validated.h5')
...
while camera.isOpened():
    ...
    if isBgCaptured == 1:
        ...
        frame_final = np.zeros(img.shape, dtype=np.uint8)
        frame_final[img>0] = 255

        # convert the image into binary image
        thresh = cv2.cvtColor(frame_final, cv2.COLOR_BGR2GRAY)
